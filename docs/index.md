...
<div class="hero">
  ...
  <div class="hero-btns">
    ...
    <a class="btn btn-dark" href="/MLH_PE_URL_Shortener/api">📄 API Docs</a>
  </div>
</div>

<div class="section-label">Tracks</div>
<div class="tracks">
  <a class="card" href="/MLH_PE_URL_Shortener/Reliability/RELIABILITY_ENGINEERING">
  ...
  <a class="card" href="/MLH_PE_URL_Shortener/TRACK2_SCALABILITY_ENGINEERING">
  ...
  <a class="card" href="/MLH_PE_URL_Shortener/TRACK3_INCIDENT_RESPONSE">
    <div class="card-icon">🚨</div>
  ...
  <a class="card" href="/MLH_PE_URL_Shortener/TRACK4_DOCUMENTATION">
    <div class="card-icon">📜</div>
